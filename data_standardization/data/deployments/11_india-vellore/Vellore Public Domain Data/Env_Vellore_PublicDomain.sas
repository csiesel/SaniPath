...
proc sql;
   ...
   select sr.*, survey.survey_type, survey.risk_response_table, neigh.neighborhood_name
   from S.surveyresponse as sr, S.survey, S.neighborhood as neigh
   where sr.survey=survey.survey_id & sr.neighborhood=neigh.neighborhood_id
