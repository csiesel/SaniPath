...
ec_prepare_idexx <- function(lab_data, reading, mpn_tbl) {
  ...
  lab_data %<>% mutate(lab_1_ecoli=NA,
                       lab_2_ecoli=NA,
                       lab_3_ecoli=NA)
...
ec_prepare_mf <- function(lab_data, reading) {
  ...
  lab_data$lab_1_ecoli[which(lab_data$lab_1_ecoli_reading_membrane== reading$TNTC)]<- config$membrane_value$TNTC #should we differentiate TNTC and TDTC?
  lab_data$lab_1_ecoli[which(lab_data$lab_1_ecoli_reading_membrane== reading$TDTC)]<- config$membrane_value$TDTC
  lab_data$lab_2_ecoli[which(lab_data$lab_2_ecoli_reading_membrane== reading$TNTC)]<- config$membrane_value$TNTC
  lab_data$lab_2_ecoli[which(lab_data$lab_2_ecoli_reading_membrane== reading$TDTC)]<- config$membrane_value$TDTC
  lab_data$lab_3_ecoli[which(lab_data$lab_3_ecoli_reading_membrane== reading$TNTC)]<- config$membrane_value$TNTC
  lab_data$lab_3_ecoli[which(lab_data$lab_3_ecoli_reading_membrane== reading$TDTC)]<- config$membrane_value$TDTC
