...
meta_produce <- read.table(paste0(getwd(), "/data/meta_data/", "meta_produce", ".csv"), 
                           sep=",", stringsAsFactors=F, header=T)
meta_streetfood <- read.table(paste0(getwd(), "/data/meta_data/", "meta_streetfood", ".csv"), 
                           sep=",", stringsAsFactors=F, header=T)
...
# exposure data
filenames <- list.files(paste0(getwd(), "/data/"), pattern="multicity_")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames))))
file <- grep(max, filenames, fixed=TRUE, value=T)
df.multi <- read.csv(paste0(getwd(), "/data/", file), stringsAsFactors = F)
...
# col
filenames <- list.files(paste0(getwd(), "/data/"), pattern="col_merged")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames)))) #remove everything before the date and after in filename
file <- grep(max, filenames, fixed=TRUE, value=T)
df.col <- read.csv(paste0(getwd(), "/data/", file))

# lab
filenames <- list.files(paste0(getwd(), "/data/"), pattern="lab_merged")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames))))
file <- grep(max, filenames, fixed=TRUE, value=T)
df.lab <- read.csv(paste0(getwd(), "/data/", file))

# h
filenames <- list.files(paste0(getwd(), "/data/"), pattern="h_merged")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames))))
file <- grep(max, filenames, fixed=TRUE, value=T)
df.h <- read.csv(paste0(getwd(), "/data/", file))

# s
filenames <- list.files(paste0(getwd(), "/data/"), pattern="s_merged")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames))))
file <- grep(max, filenames, fixed=TRUE, value=T)
df.s <- read.csv(paste0(getwd(), "/data/", file))

# c
filenames <- list.files(paste0(getwd(), "/data/"), pattern="c_merged")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames))))
file <- grep(max, filenames, fixed=TRUE, value=T)
df.c <- read.csv(paste0(getwd(), "/data/", file))

# ec data
filenames <- list.files(paste0(getwd(), "/data/"), pattern="ec_data")
max <- max((sub(".*\\_", "", sub("\\.csv.*", "", filenames))))
file <- grep(max, filenames, fixed=TRUE, value=T)
df.ecdata <- read.csv(paste0(getwd(), "/data/", file), stringsAsFactors = F)
